angular.module('app')
    .controller('programasLegalizadosDigitalizadoController', function ($scope, $routeParams, $rootScope, $location, Auth, $uibModal, utilityService, data, $uibModalInstance, workflowService) {
        ...
        confirmacionDatosPersonalesController.digitalizado = false;
        ...
        confirmacionDatosPersonalesController.next = function () {
            ...
            valoresSalida.digitalizado = confirmacionDatosPersonalesController.digitalizado;
